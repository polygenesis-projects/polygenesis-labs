...
public class Text implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return new EqualsBuilder()
        .append(original, text.original)
        .append(modified, text.modified)
        .append(lowerCase, text.lowerCase)
        .append(upperCase, text.upperCase)
        .append(upperUnderscore, text.upperUnderscore)
        .append(lowerCamel, text.lowerCamel)
        .append(upperCamel, text.upperCamel)
        .append(lowerHyphen, text.lowerHyphen)
        .append(lowerCamelSpaces, text.lowerCamelSpaces)
        .append(upperCamelSpaces, text.upperCamelSpaces)
        .isEquals();
  }
  ...
  public int hashCode() {
    return new HashCodeBuilder(17, 37)
        ...
        .append(lowerCase)
        .append(upperCase)
        .append(upperUnderscore)
        .append(lowerCamel)
        .append(upperCamel)
        .append(lowerHyphen)
        .append(lowerCamelSpaces)
        .append(upperCamelSpaces)
        .toHashCode();
  }
}
